	...
	static class Levels
	{
		...
		static void XpDeath(DeadEvent ev)
		{
			try
			{
				...
				try { if (EventHandlers.Upgrade914.ContainsKey(ev.Target.UserInfomation.UserId) && EventHandlers.Upgrade914[ev.Target.UserInfomation.UserId] && ev.Target.RoleInfomation.Role == RoleTypeId.ClassD) return; } catch { }
