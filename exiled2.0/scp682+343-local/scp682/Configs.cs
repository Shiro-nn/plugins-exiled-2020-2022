...
namespace scp682343
{
	internal static class Configs
	{
		...
		internal static void ReloadConfig()
		{
			...
			Configs.health = Plugin.Config.GetInt("scp682_health", 666);
			...
			Configs.count = Plugin.Config.GetInt("scp682_players_count", 0);
			...
			Configs.spawndogbctime = Plugin.Config.GetUShort("scp682_spawn_bc_time", 10);
			...
			Configs.repdogbctime = Plugin.Config.GetUShort("scp682_rep_bc_time", 10);
