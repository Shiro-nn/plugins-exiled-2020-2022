...
namespace PlayerXP
{
	public class EventHandlers
	{
		...
		public void OnCheckEscape(ref CheckEscapeEvent ev)
		{
			...
			AddXP(ev.Player);
			ev.Player.GetComponent<Broadcast>().TargetAddElement(ev.Player.scp079PlayerScript.connectionToClient, Configs.eb.Replace("%xp%", "100"), 10, 0);
			...
			if (matches.Count > 0)
			{
				...
				Stats[ev.Player.characterClassManager.UserId].xp += 100;
				AddXP(ev.Player);
				ev.Player.GetComponent<Broadcast>().TargetAddElement(ev.Player.scp079PlayerScript.connectionToClient, Configs.eb.Replace("%xp%", "200"), 10, 0);
			}
		}
				...
				if (ev.Killer != ev.Player)
				{
					...
					if (ev.Killer == pList.Contains(Team.CHI))
					{
						if (ev.Player == pList.Contains(Team.MTF))
						{
							...
							AddXP(ev.Killer);
							ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "50").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
						}
						else if (ev.Player == pList.Contains(Team.RSC))
						{
							Stats[ev.Killer.characterClassManager.UserId].xp += 25;
							AddXP(ev.Killer);
							ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "25").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
						}
						else if (ev.Player == pList.Contains(Team.SCP))
						{
							Stats[ev.Killer.characterClassManager.UserId].xp += 75;
							AddXP(ev.Killer);
							ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "75").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
						}
					...
					else if (ev.Killer == pList.Contains(Team.TUT))
					{
						...
						else if (ev.Player == pList.Contains(Team.SCP))
						{
							...
							AddXP(ev.Killer);
							ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "10").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
						}
					}
					else if (ev.Killer == pList.Contains(Team.RSC))
					{
						...
						else if (ev.Player == pList.Contains(Team.CHI))
						{
							...
							AddXP(ev.Killer);
							ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "100").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
						}
						else if (ev.Player == pList.Contains(Team.TUT))
						{
							Stats[ev.Killer.characterClassManager.UserId].xp += 100;
						...
						else if (ev.Player == pList.Contains(Team.SCP))
						{
							...
							AddXP(ev.Killer);
							ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "200").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
						}
					}
					...
					if (ev.Killer != ev.Player)
					{
						...
						if (ev.Killer == pList.Contains(Team.CHI))
						{
							...
							else if (ev.Player == pList.Contains(Team.SCP))
							{
								Stats[ev.Killer.characterClassManager.UserId].xp += 75;
								AddXP(ev.Killer);
								ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "150").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
							}
							else if (ev.Player == pList.Contains(Team.TUT))
							{
								Stats[ev.Killer.characterClassManager.UserId].xp += 50;
						...
						else if (ev.Killer == pList.Contains(Team.TUT))
						{
							...
							else if (ev.Player == pList.Contains(Team.SCP))
							{
								Stats[ev.Killer.characterClassManager.UserId].xp += 10;
								AddXP(ev.Killer);
								ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "20").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
							}
						}
						else if (ev.Killer == pList.Contains(Team.RSC))
						{
							...
							else if (ev.Player == pList.Contains(Team.SCP))
							{
								Stats[ev.Killer.characterClassManager.UserId].xp += 200;
								AddXP(ev.Killer);
								ev.Killer.GetComponent<Broadcast>().TargetAddElement(ev.Killer.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "400").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
							}
						}
						else if (ev.Killer == pList.Contains(Team.CDP))
						{
		...
		public void OnPocketDimensionDie(PocketDimDeathEvent ev)
		{
			...
			scp106.GetComponent<Broadcast>().TargetAddElement(scp106.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "25").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
			...
			if (matches.Count > 0)
			{
				...
				Stats[scp106.characterClassManager.UserId].xp += 25;
				AddXP(scp106);
				scp106.GetComponent<Broadcast>().TargetAddElement(scp106.scp079PlayerScript.connectionToClient, Configs.kb.Replace("%xp%", "50").Replace("%player%", $"{ev.Player.GetNickname()}"), 10, 0);
			}
		}
