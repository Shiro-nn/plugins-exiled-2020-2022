	...
	public class EventHandlers
	{
		...
		public void OnRoundStart()
		{
			if (!plugin.Ga)
			{
				...
				{
					List<ReferenceHub> playerssl = Massacre.GetHubs();
					foreach (ReferenceHub scp173 in playerssl)
					{
						if (scp173.GetRole() == RoleType.Scp173)
						{
							...
							scp173.plyMovementSync.OverridePosition(randomSP, 0f);
						}
						/* ����� �� � // ��������, ��� ������ �������
					...
					Timing.CallDelayed(1.0f, () =>
					{
						...
						Timing.CallDelayed(1.0f, () =>
						{
							foreach (ReferenceHub hub in players)
							{
								if (hub.characterClassManager.IsHuman())
								{
									...
									hub.plyMovementSync.OverridePosition(randomSP, 0f);
									hub.inventory.Clear();
						...
						Timing.CallDelayed(120f, () =>
						{
							...
							foreach (ReferenceHub nut in players)
							{
								...
								{
									Vector3 randomSP = Map.GetRandomSpawnPoint(RoleType.Scp93989);
									nut.plyMovementSync.OverridePosition(randomSP, 0f);
								}
								/* ����� �� � // ��������, ��� ������ �������
								if (scp173.characterClassManager.IsHuman())
								{
			...
			if (plugin.RoundStarted)
			{
				...
				if (plugin.sd)
				{
					Timing.CallDelayed(3.0f, () =>
					{
						...
						Timing.CallDelayed(0.5f, () =>
						{
							...
							ev.Player.plyMovementSync.OverridePosition(randomSP, 0f);
							ev.Player.plyMovementSync.OverridePosition(randomP, 0f);
				...
				if (plugin.sp)
				{
					Timing.CallDelayed(3.0f, () =>
					{
						...
						ev.Player.plyMovementSync.OverridePosition(randoSP, 0f);
						Timing.CallDelayed(0.5f, () =>
						{
							Vector3 andoSP = Map.GetRandomSpawnPoint(RoleType.Scp93989);
							ev.Player.plyMovementSync.OverridePosition(andoSP, 0f);
						}
						);
					});
				}
