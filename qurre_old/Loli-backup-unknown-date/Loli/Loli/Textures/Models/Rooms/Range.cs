...
namespace Loli.Textures.Models.Rooms
{
    ...
    {
        internal const string DoorName = "Range_Armory_Door";

        public static List<CustomDoor> CustomDoors = new();
        internal static Range Static;
        private static readonly Color32 Steklo = new(0, 0, 0, 100);
        public Model Model;
        ...
        {
            Static = this;
            Model = new Model("Range", new(-300, -650, -1100), Vector3.zero);
            SpawnPoint = new Model("SpawnPoint", new(-16, 2), Vector3.zero, Model).GameObject.transform;

            Model.AddPart(new ModelLight(Model, Color.white, new(20.3f, 16.26f, 8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(20.3f, 16.26f, -8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(8.25f, 14, 8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(8.25f, 14, -8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(-4.02f, 14, 8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(-4.02f, 14, -8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(-17.57f, 14, 8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(-17.57f, 14, -8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(-32.23f, 14, 8.5f), 0.5f, 40, false));
            Model.AddPart(new ModelLight(Model, Color.white, new(-32.23f, 14, -8.5f), 0.5f, 40, false));

            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 0), Vector3.zero, new(50, 0.1f, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-5, 18.9f), Vector3.zero, new(60, 0.1f, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 0.744f), Vector3.zero, new(0.4f, 1.4f, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 4), Vector3.zero, new(0.4f, 1.4f, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 9.52f, 12), Vector3.zero, new(0.4f, 19, 1)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 9.52f, -12), Vector3.zero, new(0.4f, 19, 1)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 11.42f, 8), Vector3.zero, new(0.4f, 15, 2)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 11.42f, -8), Vector3.zero, new(0.4f, 15, 2)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 11.42f, 3), Vector3.zero, new(0.4f, 15, 2)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 11.42f, -3), Vector3.zero, new(0.4f, 15, 2)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 17.1f), new(-45.02f, 0), new(0.4f, 20, 20)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 9.45f, -12.5f), new(90, 0), new(50, 0.1f, 19)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-10, 9.45f, 12.5f), new(90, 0), new(50, 0.1f, 19)));

            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(15, 3.58f), Vector3.zero, new(0.4f, 7, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(19.87f, 5.73f), Vector3.zero, new(10, 0.1f, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(15, 10.5f, -11), Vector3.zero, new(0.4f, 7, 3)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(15, 10.5f, 11), Vector3.zero, new(0.4f, 7, 3)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(15, 16.43f), Vector3.zero, new(0.4f, 5, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Steklo, new(15, 10.5f), Vector3.zero, new(0.39f, 7, 19)));

            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(19.87f, 14.65f, -12.5f), new(90, 0), new(10, 0.1f, 8.6f)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(23.62f, 7.928f, -12.5f), new(90, 0), new(2.5f, 0.1f, 4.9f)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(15.976f, 7.928f, -12.5f), new(90, 0), new(2.5f, 0.1f, 4.9f)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(23.62f, 7.928f, 12.52f), new(90, 0), new(2.5f, 0.1f, 4.9f)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(15.976f, 7.928f, 12.52f), new(90, 0), new(2.5f, 0.1f, 4.9f)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(19.87f, 14.65f, 12.52f), new(90, 0), new(10, 0.1f, 8.6f)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(24.82f, 12.3f), Vector3.zero, new(0.4f, 13.2f, 25)));

            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-25.2f, 11.35f), Vector3.zero, new(0.4f, 16, 25)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-25.2f, 2.02f, -0.05f), Vector3.zero, new(0.4f, 4, 3)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-25.2f, 2.02f, -11.5f), Vector3.zero, new(0.4f, 4, 2)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-25.2f, 2.02f, -6.03f), Vector3.zero, new(0.4f, 4, 5)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-34.84f, 9.45f), Vector3.zero, new(0.4f, 19, 25)));

            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Quad, Color.white, new(-32.82f, 2.489f, 5.504f), new(58, 0), new(3.7f, 9.3f, 1)));
            Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Quad, Color.white, new(-32.82f, 4.955f, 10.94f), new(90, 0), new(3.7f, 3, 1)));
...

            {
                ...
                new Lift(new(room.Transform, new(0, 2.5f, 0.45f), Vector3.zero), new(Model.GameObject.transform, new(19.92f, 8.22f, -12.65f), Vector3.zero, true));
                Primitive prim = new(PrimitiveType.Cube);
            ...
            DestroyLater = new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-23.97f, 9.45f), Vector3.zero, new(0.4f, 19, 25));
        }
        internal static void ClearWaitInv()
        {
            ...
            if (timer < 0) return;
            if (timer > 1) return;
            foreach (var pl in Player.List) while (pl.AllItems.Count > 0) pl.RemoveItem(pl.AllItems.ElementAt(0), true);
        ...
        internal static void RoundStart()
        {
            ...
            Timing.CallDelayed(5f, () =>
            {
                ...
                {
                    new Lift(new(Static.Model.GameObject.transform, new(19.71f, 8.22f, 12.67f), new(0, 180), true), new(Static.Model.GameObject.transform, new(-25.2f, 2.51f, 4.18f), new(0, 90), true));
                    {
                        Map.Rooms.TryFind(out var room, x => x.Type == RoomType.HczArmory);
                        new Lift(new(room.Transform, new(-0.29f, 2.44f), new(0, 990)), new(Static.Model.GameObject.transform, new(-25.2f, 2.51f, 9.71f), new(0, 90), true));
                        var door = DoorType.HCZ_Armory.GetDoor();
                        door.Position += Vector3.down;
                        door.Scale = Vector3.zero;
                        Timing.CallDelayed(5, () =>
                        {
                            var _ilist = Map.Pickups.Where(x => Vector3.Distance(room.Position, x.Position) < 5 && (x.Type == ItemType.GunCOM18 ||
                            x.Type == ItemType.Ammo9x19 || x.Type == ItemType.Ammo556x45 || x.Type == ItemType.Radio || x.Type == ItemType.Flashlight));
                            foreach (var i in _ilist) try { i.Destroy(); } catch { }
                            var _wlist = Map.WorkStations.Where(x => Vector3.Distance(room.Position, x.Position) < 10);
                            foreach (var w in _wlist) try { w.Position = Vector3.zero; } catch { }
                            var _llist = Map.Lockers.Where(x => Vector3.Distance(room.Position, x.Position) < 10 && x.Type == LockerType.Pedestal);
                            Map.Rooms.TryFind(out var ch, x => x.Type == RoomType.HczEzCheckpoint);
                            foreach (var l in _llist) try
                                {
                                    l.GameObject.transform.parent.position = Vector3.zero;
                                    for (int i = 0; i < l.GameObject.transform.parent.parent.childCount; i++)
                                    {
                                        Transform child = l.GameObject.transform.parent.parent.GetChild(i);
                                        if (child.name == "Armory") child.position = Vector3.zero;
                                    }
                                }
                                catch { }
                        });
                ...
                }
                {
...

                    {
                        ...
                        WorkStation.Create(tr.position, tr.rotation.eulerAngles, Vector3.one);
                    }
                    {
                        GameObject obj = new();
                        var tr = obj.transform;
