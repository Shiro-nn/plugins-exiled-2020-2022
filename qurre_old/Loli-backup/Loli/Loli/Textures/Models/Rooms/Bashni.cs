...
namespace Loli.Textures.Models.Rooms
{
    ...
    {
        internal static Vector3 ChaosSpawnPoint = Map.GetRandomSpawnPoint(RoleType.ChaosConscript);
        internal static Vector3 MTFSpawnPoint = Map.GetRandomSpawnPoint(RoleType.NtfCaptain);
