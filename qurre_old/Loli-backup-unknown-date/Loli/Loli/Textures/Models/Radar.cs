...
namespace Loli.Textures.Models
{
    internal class Radar
    {
        ...
        internal Radar(Vector3 pos, Vector3 rot, Model root = null)
        {
            Model = new Model($"Radar_" + pos, pos, rot, root);
            ...
            void CreatePanel(Vector3 _pos, Vector3 _rot)
            {
                ...
                _panel.AddPart(new ModelPrimitive(_panel, PrimitiveType.Cube, Color.white, Vector3.zero, Vector3.zero, new Vector3(0.3f, 4, 4)));
                _panel.AddPart(new ModelPrimitive(_panel, PrimitiveType.Cube, Color.white, new Vector3(0.674f, 0, 3.83f), new Vector3(0, 20), new Vector3(0.3f, 4, 4)));
                _panel.AddPart(new ModelPrimitive(_panel, PrimitiveType.Cube, Color.white, new Vector3(0.674f, 0, -3.83f), new Vector3(0, -20), new Vector3(0.3f, 4, 4)));
            }
        ...
        internal class KrutilkaScript : MonoBehaviour
        {
            void Update()
            {
                transform.Rotate(Vector3.down * 0.1f);
            }
        }
