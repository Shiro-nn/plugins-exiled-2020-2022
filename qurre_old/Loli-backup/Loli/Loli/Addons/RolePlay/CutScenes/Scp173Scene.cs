...
namespace Loli.Addons.RolePlay.CutScenes
{
    public class Scp173Scene
    {
        ...
        {
            if (Plugin.RolePlay && ev.Player.Tag.Contains("Custom173Pos") && !Plugin.HardRP) ev.Position = Map.GetRandomSpawnPoint(RoleType.Scp173);
        }
        internal void FixTP(DroppingItemEvent ev)
        {
            if (Plugin.RolePlay && ev.Player.Tag.Contains("Custom173Pos") && !Plugin.HardRP) ev.Allowed = false;
        }
        ...
        {
            if (Plugin.RolePlay && ev.Target.Tag.Contains("Custom173Pos") && !Plugin.HardRP) ev.Allowed = false;
        }
        ...
        internal void StartRound()
        {
            ...
            try
            {
                ...
                if (pl173 != null)
                {
                    ...
                    pl173.ChangeModel(RoleType.Scp173);
                    pl173.Position = Map.GetRandomSpawnPoint(RoleType.Scp173);
                ...
                void DoSpawn(Vector3 pos, Vector3 rot, Vector3 cof = new Vector3())
                {
                    ...
                    Timing.CallDelayed(later, () =>
                    {
                        ...
                        Map.PlaceBlood(pos + Vector3.up, BloodType.Spreaded, 3);
                        bot.Destroy();
                    });
                    if (localId == 2)
                    {
                ...
                void DTeleport(Vector3 pos, Vector3 postpos)
                {
                    ...
                    void SeeD(Player pl)
                    {
                        ...
                        pl.ChangeModel(RoleType.ClassD);
                        pl.Position = Map.GetRandomSpawnPoint(RoleType.Scp173);
            ...
            Timing.CallDelayed(20f, () =>
            {
                ...
                Map.PlaceBlood(room.Position + Vector3.up, BloodType.Spreaded, 3);
            });
            ...
            Timing.CallDelayed(43f, () =>
            {
                ...
                Timing.CallDelayed(15f, () =>
                {
                    ...
                    Timing.CallDelayed(15f, () =>
                    {
                        ...
                        UpdateLight(Qurre.API.Extensions.GetRoom(RoomType.LczClassDSpawn).Lights);
                        UpdateLight(Qurre.API.Extensions.GetRoom(RoomType.Lcz173).Lights);
                        UpdateLight(Qurre.API.Extensions.GetRoom(RoomType.Hcz106).Lights);
                    });
