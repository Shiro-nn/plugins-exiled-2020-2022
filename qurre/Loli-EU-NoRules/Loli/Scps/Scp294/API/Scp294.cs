    ...
    public sealed class Scp294
    {
        ...
        public void Spawn(Vector3 position, Vector3 rotation)
        {
            try
            {
                ...
                // Ключ карта
                var door = new ModelDoor(Model, DoorPrefabs.DoorHCZ, new Vector3(0.6204987f / 0.725f, 0.5434804f / 0.725f, 0.50682f / 0.725f), new Vector3(0, 90, 180), new Vector3(0.125f, 0.05f, 0.1f));
                Model.AddPart(door);
                Doors.Add(door.Door);
                door.Door.Name = Builds.Load.StaticDoorName;
            }
