	...
	public class Plugin : EXILED.Plugin
	{
		...
		public override void OnEnable()
		{
			try
			{
                ...
                banWebhookURL = Config.GetString("srvban_webhook", "");
                RoleIDsToPing = Config.GetString("srvreport_roleids", "");
                CustomMessage = Config.GetString("srvreport_custom_message", "����� ������!");
                TMessage = Config.GetString("srvban_custom_message", "��� �� ������� ..!");
		...
		public override string getName { get; } = "Discord";
	}
}