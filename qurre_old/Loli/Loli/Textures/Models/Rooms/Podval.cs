...
namespace Loli.Textures.Models.Rooms
{
    internal class Podval
    {
        ...
        public Podval(Vector3 position, Vector3 rotation)
        {
            ...
            var spawnPoint = new Model("SpawnPoint", new(-2.59f, 0, 13.57f), Vector3.zero, Model);
            if (SpawnpointManager.Positions.ContainsKey(RoleType.Tutorial)) SpawnpointManager.Positions[RoleType.Tutorial] = new GameObject[] { spawnPoint.GameObject };
