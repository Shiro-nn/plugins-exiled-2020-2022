...
namespace MongoDB.events.Poltergeist
{
    public static class Extensions
	{
		...
		public static void Checkopen()
		{
			...
			{
				Timing.CallDelayed(1.51f, () => tesla.RpcInstantTesla());
				Timing.CallDelayed(11.4f, () => tesla.RpcInstantTesla());
				Timing.CallDelayed(21.4f, () => tesla.RpcInstantTesla());
				Timing.CallDelayed(31.4f, () => tesla.RpcInstantTesla());
				Timing.CallDelayed(41.4f, () => tesla.RpcInstantTesla());
				Timing.CallDelayed(51.4f, () => tesla.RpcInstantTesla());
			}
		}
	}
}
