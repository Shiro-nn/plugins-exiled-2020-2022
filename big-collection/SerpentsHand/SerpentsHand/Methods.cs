    ...
    partial class EventHandlers
    {
        internal static void SpawnPlayer(ReferenceHub player, bool full = true)
        {
            ...
            if (full)
            {
                ...
                player.GetComponent<Broadcast>().TargetAddElement(player.scp079PlayerScript.connectionToClient, "<color=red>��</color> <color=#15ff00>����� ����</color>\n<color=#00ffdc>���� ������ ����� ����, ����� SCP</color>", 10, false);
