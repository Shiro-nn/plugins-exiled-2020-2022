...
namespace Loli.Textures.Models
{
    internal class Lift
    {
        ...
        internal Lift(LiftCreator first, LiftCreator second)
        {
            ...
            LocalCreator Create(LiftCreator cre, bool first)
            {
                ...
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-1.87f, 0), Vector3.zero, new(1.8f, 4.9f, 0.4f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(1.87f, 0), Vector3.zero, new(1.8f, 4.9f, 0.4f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-0.0169f, 1.63f), Vector3.zero, new(2, 1.64f, 0.4f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(-2.72f, 0, -2.995f), Vector3.zero, new(0.1f, 4.9f, 5.6f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(2.72f, 0, -2.995f), Vector3.zero, new(0.1f, 4.9f, 5.6f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(0, 0, -5.745f), new(0, 90), new(0.1f, 4.9f, 5.5f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(0, -2.485f, -2.75f), new(0, 0, 90), new(0.1f, 5.5f, 5.9f)));
                Model.AddPart(new ModelPrimitive(Model, PrimitiveType.Cube, Color.white, new(0, 2.4f, -2.94f), new(0, 0, 90), new(0.1f, 5.5f, 5.6f)));
        ...
        internal void Interact()
        {
            ...
            IEnumerator<float> ToFirst()
            {
                ...
                foreach (var pl in Map.Pickups.Where(x => InLift(x.Position) && !x.Base.ItsNeededItem()))
