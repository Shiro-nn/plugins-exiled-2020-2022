...
{
	static internal class BroadCasts
	{
		static internal IEnumerator<float> Send()
		{
			...
			for (; ; )
			{
				...
				if (random < 20)
				{
					Map.Broadcast("<size=30%><b><color=#ff1f00>Хотите вступить в клан</color><color=#0089c7>?</color></b>\n" +
						"<color=#bb00ff>Вы можете вступить в клан на сайте <color=#fdffbb>scpsl<color=red>.</color>store</color></color></size>", 20);
					/*Map.Broadcast("<color=#55ff5a>Хотите получить <color=#a9f550>преимущество</color>, не покупая донат?</color>\n" +
						"<size=30%><color=#ed26ff>Вы можете найти ключи на сервере в Discord, общаясь там.</color></size>", 20);*/
				}
				else if (random < 32)
				{
					Map.Broadcast("<b><color=#00ffff>Хотите узнать <color=red>TPS</color> серверов?</color></b>\n" +
						"<size=30%><color=#0089c7>Вы можете узнать <color=red>TPS</color> серверов за\nпоследнее время на сайте </color>" +
						"<color=#fdffbb>scpsl<color=#0089c7>.</color>store</color></size>", 20);
				}
				else if (random < 44)
				{
					Map.Broadcast("<size=30%><b><color=#00ffff>Хотите узнать консольные команды</color>?</b>\n" +
				...
				{
					Map.Broadcast("<size=30%><color=#fdffbb>Хотите поддержать проект</color><color=red>?</color>\n" +
				...
				{
					Map.Broadcast("<size=30%><b><color=#00ffff>Есть <color=red>Жалобы</color>? <color=#15ff00>Предложения</color>? <color=#006dff>Вопросы</color>? " +
				...
				else if (random < 85)
				{
					Map.Broadcast("<b><color=#eb1bff>Хотите разнообразия</color><color=#0089c7>?</color></b>\n" +
						"<size=30%><color=#00ff00>Вы можете <color=#0089c7>кастомизировать</color> своего персонажа на сайте\n" +
