...
namespace Scp294.API
{
    ...
    {
        private static Color32 DarkColor => new Color32(39, 39, 39, 255);
        private static Color32 DarkGrayColor => new Color32(77, 77, 77, 255);
        private static Color32 GrayColor => new Color32(200, 200, 200, 255);
        private static Color32 ScreenColor => new Color32(92, 166, 156, 255);
        private static Color32 GreenMiniScreenColor => new Color32(146, 192, 144, 255);
        private static Color32 GlassColor => new Color32(133, 120, 229, 75);
