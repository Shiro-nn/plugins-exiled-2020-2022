...
namespace Loli.Addons
{
    static class Gate3
    {
        ...
        internal static void DoorTeleport()
        {
            ...
            {
                if (pl.MovementState.Position.y < 992 && pl.MovementState.Position.y > 980 &&
                    pl.MovementState.Position.x <= DoorEntrance_Pos2.x && pl.MovementState.Position.x >= DoorEntrance_Pos1.x &&
                    pl.MovementState.Position.y <= DoorEntrance_Pos2.y && pl.MovementState.Position.y >= DoorEntrance_Pos1.y &&
                    pl.MovementState.Position.z <= DoorEntrance_Pos2.z && pl.MovementState.Position.z >= DoorEntrance_Pos1.z)
                    pl.MovementState.Position = DoorEntrance_Tp;
                else if (pl.MovementState.Position.y < 992 && pl.MovementState.Position.y > 980 &&
                    pl.MovementState.Position.x <= DoorExit_Pos2.x && pl.MovementState.Position.x >= DoorExit_Pos1.x &&
                    pl.MovementState.Position.y <= DoorExit_Pos2.y && pl.MovementState.Position.y >= DoorExit_Pos1.y &&
                    pl.MovementState.Position.z <= DoorExit_Pos2.z && pl.MovementState.Position.z >= DoorExit_Pos1.z)
