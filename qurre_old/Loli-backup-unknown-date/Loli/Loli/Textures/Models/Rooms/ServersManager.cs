...
namespace Loli.Textures.Models.Rooms
{
    internal static class ServersManager
    {
        ...
        internal static readonly List<ItemPickupBase> Buttons = new();
                ...
                while (Hacking)
                {
                    ...
                    if (Proccess > 99)
                    {
                        ...
                        var str = $"<color=rainbow><b>Внимание всему персоналу</b></color>\n" +
                            $"<size=30%><color=#6f6f6f><color=red>Хакер</color> <color=green>Повстанцев Хаоса</color> успешно выкачал <color=red>все</color> данные комплекса.\n" +
        ...
        internal static void Initialize()
        {
            ...
            ServersRoom = new Servers(new Vector3(-88.47f, -1012.2f, -69.76f), Vector3.zero);
            new Lift(new(ServersRoom.Model.GameObject.transform, new(7.22f, 2.5f, -4.14f), Vector3.zero, true), new(null, new(-81.25f, 990.24f, -73.74f), Vector3.zero, true));
        }
    }
}