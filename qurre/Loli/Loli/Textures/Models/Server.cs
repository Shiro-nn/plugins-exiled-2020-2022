    ...
    internal class Server
    {
        ...
        internal Server(Vector3 pos, Vector3 rot, Model root = null)
        {
            ...
            #region Door
            {
                ...
                item.PickupDropModel.Info._serverPosition = Door.GameObject.transform.position + _p;
                item.PickupDropModel.Info.Weight = item.Weight;
                item.PickupDropModel.Info._serverRotation = Quaternion.Euler(Door.GameObject.transform.rotation.eulerAngles + new Vector3(0, 0, 90));
            ...
            Timing.CallDelayed(1f, () => Model.Primitives.ForEach(prim =>
            {
                ...
                try { Object.Destroy(prim.Primitive.Base._spawnedPrimitve.GetComponent<Collider>()); } catch (System.Exception e) { Log.Warn(e); }
