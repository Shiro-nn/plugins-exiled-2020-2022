...
namespace Loli.Addons.RolePlay
{
    internal class Manager
    {
        ...
        internal SafeSystem SafeSystem;
        ...
        internal void RegisterEvents()
        {
            ...
            SafeSystem = new SafeSystem();
            Qurre.Events.Player.Spawn += SafeSystem.FixTags;
            Qurre.Events.Player.RoleChange += SafeSystem.FixTags;
            Qurre.Events.Player.Dead += SafeSystem.FixTags;
            ...
            Qurre.Events.Player.Spawn += Scp106.Spawn;
            Qurre.Events.Player.DamageProcess += Scp106.Damage;

            Qurre.Events.Round.Waiting += Safe079.Waiting;
            Qurre.Events.Player.InteractGenerator += Safe079.GenAct;
            Qurre.Events.Scp079.GeneratorActivate += Safe079.GenAct;
        }
    }
}