...
namespace Loli.Modules
{
	static class Another
	{
		...
		{
			Log.Debug("Encode server name; иногда блокирует наличие qurre в названии idk почему");
			Log.Debug(StringUtils.Base64Encode(ServerConsole.singleton.RefreshServerNameSafe()).Replace('+', '-'));
		}
