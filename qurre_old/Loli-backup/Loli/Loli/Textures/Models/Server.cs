    ...
    internal class Server
    {
        ...
        internal Server(Vector3 pos, Vector3 rot, Model root = null)
        {
            ...
            #region Door
            {
                ...
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Cylinder, _color, Vector3.zero, Vector3.zero, new Vector3(0.05f, 1.45f, 0.05f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Cube, _color, new Vector3(0, 0, 0.05f), Vector3.zero, new Vector3(0.06f, 2.9f, 0.05f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Cube, _color, new Vector3(0, 0, 0.9464f), Vector3.zero, new Vector3(0.06f, 2.9f, 0.05f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Cube, _color, new Vector3(0, -1.403f, 0.501f), Vector3.zero, new Vector3(0.06f, 0.1f, 0.85f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Cube, _color, new Vector3(0, 1.3983f, 0.501f), Vector3.zero, new Vector3(0.06f, 0.1f, 0.85f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Cylinder, _color, new Vector3(0.001f, 0, 0.861f), new Vector3(0, 0, 90), new Vector3(0.15f, 0.034f, 0.15f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Quad, steklo, new Vector3(-0.029f, 0, 0.499f), RotForQuad, new Vector3(0.855f, 2.71f, 0.01f)));
                Model.AddPart(new ModelPrimitive(Door, PrimitiveType.Quad, steklo, new Vector3(0.029f, 0, 0.499f), new Vector3(0, 270, 0), new Vector3(0.855f, 2.71f, 0.01f)));
            ...
            Timing.CallDelayed(1f, () => Model.Primitives.ForEach(prim =>
            {
                ...
                try { Object.Destroy(prim.Primitive.Base._spawnedPrimitve.GetComponent<Collider>()); } catch (System.Exception e) { Qurre.Log.Warn(e); }
                if (prim.Primitive.Type is PrimitiveType.Quad) prim.Primitive.Rotation = Quaternion.Euler(prim.Primitive.Rotation.eulerAngles + Vector3.up * 180);
            }));
        }
