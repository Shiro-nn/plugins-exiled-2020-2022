...
namespace Loli.Addons
{
    internal static class Gate3
    {
        internal static void Load()
        {
            ...
            Model.AddPart(new ModelPrimitive(Model, prim, stena_white, new(23.62f, 993.8f, -10.92f), new(0, 90, 0), new(8, 3, 1)));//34
            ...
            Model.AddPart(new ModelPrimitive(Model, prim, stena_white, new(-188.72f, 993.66f, -43.7f), new(0, 270, 0), new(78, 13, 1)));//40
        ...
        {
            foreach (var pl in Player.List.Where(pl => pl.Position.y < 992 && pl.Position.y > 980 &&
