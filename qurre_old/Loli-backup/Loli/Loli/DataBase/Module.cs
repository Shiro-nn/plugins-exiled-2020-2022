	...
	public static class Module
	{
		public static string Prefix(Player pl)
		{
			...
			if (Manager.Static.Data.Users.TryGetValue(userId, out var main))
			{
				...
				if (main.owner)
				{
					if (Plugin.HardRP) return "<color=#ff6100>[Контроль HRP]</color> ";
					return "<color=#ffe000>[Контроль Админов]</color> ";
				}
			...
			try { if (Modules.Patrol.List.Contains(pl.UserId)) return ""; } catch { }
