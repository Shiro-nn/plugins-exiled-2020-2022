...
namespace Loli.Addons.RealSpawn
{
    internal static class Chaos
    {
        ...
        {
            Car = SchematicUnity.API.SchematicManager.LoadSchematic(Path.Combine(Pathes.Plugins, "Schemes", "ChaosCar.json"),
                new(-192, 988.984f, -13.53454f), Quaternion.identity);
            Gate = SchematicUnity.API.SchematicManager.LoadSchematic(Path.Combine(Pathes.Plugins, "Schemes", "Gate.json"),
