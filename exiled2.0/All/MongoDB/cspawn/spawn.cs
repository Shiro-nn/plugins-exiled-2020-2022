	...
	public class spawn
	{
		...
		public void nspawn(SpawningEventArgs ev)
		{
			Timing.CallDelayed(0.2f, () =>
			{
				...
				else if (ev.Player.ReferenceHub.GetRole() == RoleType.Scp096)
				{
					ev.Player.ReferenceHub.playerStats.maxHP = 1000;
					ev.Player.ReferenceHub.playerStats.Health = 1000;
				}
				...
				{
					ev.Player.ReferenceHub.playerStats.maxHP = 750;
					ev.Player.ReferenceHub.playerStats.Health = 750;
				}
