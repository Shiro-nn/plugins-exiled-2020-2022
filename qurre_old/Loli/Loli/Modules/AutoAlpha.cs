...
namespace Loli.Modules
{
	...
	{
		public static bool AutoAlphaInProgress { get; set; } = false;
		internal bool AlphaKill { get; set; } = false;
		internal bool AlphaEnabled { get; set; } = false;
		internal bool AlphaDiscusion { get; set; } = false;
