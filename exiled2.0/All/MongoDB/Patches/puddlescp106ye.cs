			...
			else
			{
				...
				else
				{
					...
					if (scpimmune)
					{
						...
						bool flag3 = component == null || component.IsAnyScp() || component.CurClass == RoleType.Tutorial || pl.ReferenceHub.queryProcessor.PlayerId == scp343Data.GetScp343()?.queryProcessor.PlayerId || pl.ReferenceHub.queryProcessor.PlayerId == Scp228Data.GetScp228()?.queryProcessor.PlayerId || pl.ReferenceHub.queryProcessor.PlayerId == Scp035Data.GetScp035()?.queryProcessor.PlayerId;
						if (flag3)
						{
							return false;
						}
