...
namespace Loli.Textures.Models.Rooms
{
    public class Control
    {
        ...
        internal void Interact(Player pl)
        {
            ...
            {
                Lights.TurnOff(1);
                Timing.CallDelayed(1f, () => Lights.ChangeColor(_color));
            }
            catch { }
            ...
            IEnumerator<float> UpdateColorMonitor()
            {
                ...
                for (; ; )
                {
                    try { Lights.ChangeColor(_color); } catch { }
                    ...
                    catch
                    {
                        ...
                        try
                        {
                            foreach (Room room in Map.Rooms)
                            {
                                ...
                                {
                                    room.LightsOff(1);
                                    Timing.CallDelayed(1f, () => room.LightOverride = false);
                                }
                                catch { }
                            }
                        }
                    ...
                    if (Proccess > 99)
                    {
                        ...
                        try
                        {
                            foreach (Room room in Map.Rooms)
                            {
                                ...
                                {
                                    room.LightsOff(1);
                                    Timing.CallDelayed(1f, () => room.LightColor = Color.red);
                                }
                                catch { }
                            }
                        }
